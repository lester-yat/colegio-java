...
public class EditarGrado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 20, 200, 33));
        ...
        txtNombre3.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        ...
        txtSalon3.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        ...
        txtNivel3.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        ...
        txtJornada3.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        ...
        txtCantMaxEstu3.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        ...
        btnActualizar1.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        ...
        btnCancelar1.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
    ...
    txtAnio.getDate() != null && !"".equals(txtJornada3.getText()) && !"".equals(txtCantMaxEstu3.getText())) {

    try {
        // Validación de cantidad máxima de estudiantes
        int cantidadMaxEstudiantes = Integer.parseInt(txtCantMaxEstu3.getText());
        if (cantidadMaxEstudiantes < 10 || cantidadMaxEstudiantes > 50) {
            JOptionPane.showMessageDialog(null, "La cantidad máxima de estudiantes debe estar entre 10 y 50.");
            return;
        }
        ...
        grado.setSalon(txtSalon3.getText());  // Acepta valor de tipo String
        grado.setNivel(txtNivel3.getText());
        grado.setJornada(txtJornada3.getText());
        grado.setCantidadMaxEstudiantes(cantidadMaxEstudiantes);
